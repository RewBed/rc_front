      ...
      <div id="expertise" className="blog-area ptb-100">
        <div className="container">
          <div className="section-title">
            <h2>Экспертиза</h2>
            <p>
              Разбираем практические задачи разработки, интеграций, CRM,
              телефонии, госсектора и продвижения: как проектировать решения,
              запускать их в работу и поддерживать результат после релиза.
            </p>
          </div>
